                            ...
                            <div class="grid grid-cols-12 gap-6">
                                ...
                                <div class="col-span-12 lg:col-span-9 space-y-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <!-- Award Category Performance Radar -->
                                        <div class="analytics-card p-6">
                                            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4 flex items-center gap-2">
        ...
        function showAwardsMet() {
            ...
            if (totalCount === 0) {
                ...
                requirements.forEach(req => {
                    ...
                    let statusBadge = '';
                    if (matchPct >= 90) {
                        statusBadge = '<span class="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-medium">✅ Eligible</span>';
                    } else if (matchPct >= 70) {
                        statusBadge = '<span class="px-2 py-1 bg-yellow-100 text-yellow-700 rounded text-xs font-medium">🟡 Almost Eligible</span>';
                    } else {
                        statusBadge = '<span class="px-2 py-1 bg-red-100 text-red-700 rounded text-xs font-medium">❌ Not Eligible</span>';
                    }
                    ...
                    tableRows += `
                        <tr class="border-b border-green-100 hover:bg-green-50">
                            ...
                            <td class="py-3 text-gray-600 text-sm">${dateAchieved}</td>
            ...
            if (totalCount === 0) {
                ...
                requirements.forEach(req => {
                    ...
                    if (matchPct >= 90) {
                        ...
                        statusBadge = '<span class="px-2 py-1 bg-yellow-100 text-yellow-700 rounded text-xs font-medium">🟡 Almost</span>';
                    } else {
                        statusBadge = '<span class="px-2 py-1 bg-red-100 text-red-700 rounded text-xs font-medium">❌ Not Eligible</span>';
                    }
                    ...
                    tableRows += `
                        <tr class="border-b border-blue-100 hover:bg-blue-50">
                            <td class="py-3 text-gray-800 font-medium">${submissionTitle}</td>
                            <td class="py-3 text-gray-600 text-sm">${awardName}</td>
                            <td class="py-3 text-gray-600 text-sm">${fileIcon} ${fileText}</td>
                            <td class="py-3 text-gray-600 text-sm">${dateAnalyzed}</td>
                            <td class="py-3">${statusBadge}</td>
                        </tr>
                    `;
                });
